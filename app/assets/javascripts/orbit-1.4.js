...
(function($) {
  ...
  var ORBIT = {
    ...
    defaults: {
      ...
      // fade, horizontal-slide, vertical-slide, horizontal-push, vertical-push
      animationSpeed: 600,
      ...
      // text of right directional element for accessibility
      directionalNavLeftText: 'Left',
      // text of left directional element for accessibility
      captions: true,
      ...
      // true resets the timer instead of pausing slideshow progress on manual navigation
      bullets: false,
    ...
    init: function(element, options) {
      var $imageSlides, imagesLoadedCount = 0,
          self = this;
    ...
    setCaption: function() {
      ...
      if (captionLocation) {
        ...
        this.$caption.attr('id', captionLocation) // Add ID caption TODO why is the id being set?
